...
$(document).ready(() => {
  const links = [
    {
      name: 'Peterr',
      link: '76561198117712012',
    },
    {
      name: 'Noa',
      link: '76561198152272555',
    },
    {
      name: 'Luis',
      link: '76561198028294082',
    },
    {
      name: 'HooDi',
      link: '76561198135657789',
    },
    {
      name: 'House',
      link: '76561199089637134',
    },
  ];
  ...
  app.titleChanger(['Peter', 'Noa', 'Luis', 'HooDi', 'House', '=', 'spacemovie.1992', 'Song name: KUSO GVKI - Cinnamon (feat. Apfel) (splash! Mag Premiere)']);
...
$.getJSON(ipgeolocation, (data) => {
  writeLine(['Authenticating...', "Granting access to <span style='font-size: 14px; color: #e5ff00;'>[unknown]</span>..."], 30, () => {
    ...
    writeLine([`Access granted! <span style='font-size: 14px; color: #0f0;'>[success]</span>`, `Welcome back, <i style='color: #0f0'>${ip}</i>! By the way, nice to see someone from ${country} here!`], 30, 500, () => {
      ...
      writeLine([`<i style='color: #8a0f75'>spacemovie.1 9 9 2</i>`], 120, 500, () => {
        timeouts.push(
          setTimeout(() => {
            if (app.skippedIntro) return;
...
const skipIntro = () => {
  ...
  $('#main').fadeOut(100, () => {
    ...
    setTimeout(() => {
      ...
      $('.froggy').css('visibility', 'visible').hide().fadeIn(100);
